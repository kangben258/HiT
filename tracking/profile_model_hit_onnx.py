...
if __name__ == "__main__":
    ...
    '''get some onnx model'''
    onnx_name = prj_path + "/checkpoints/train/%s/%s/VT_ep%04d.onnx" % (args.script, args.config, cfg.TEST.EPOCH)
    ort_session = onnxruntime.InferenceSession(onnx_name,providers=['CUDAExecutionProvider'])
