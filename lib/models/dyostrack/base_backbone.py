...
from lib.models.dyostrack.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def finetune_track(self, cfg, patch_start_index=1):
        ...
        new_patch_size = cfg.MODEL1.BACKBONE.STRIDE

        self.cat_mode = cfg.MODEL1.BACKBONE.CAT_MODE
        self.return_inter = cfg.MODEL1.RETURN_INTER
        self.return_stage = cfg.MODEL1.RETURN_STAGES
        self.add_sep_seg = cfg.MODEL1.BACKBONE.SEP_SEG
