class EnvironmentSettings:
    def __init__(self):
        self.workspace_dir = '/root/EdgeTrack'    # Base directory for saving network checkpoints.
        self.tensorboard_dir = '/root/EdgeTrack-main/tensorboard'    # Directory for tensorboard files.
        self.pretrained_networks = 'EdgeTrack-main/pretrained_networks'
