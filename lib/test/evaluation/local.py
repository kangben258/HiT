...
def local_env_settings():
    ...
    settings.network_path = '/home/kb/kb/git_dyhit/HiT/lib/test/networks'    # Where tracking networks are stored.
    ...
    settings.prj_dir = '/home/kb/kb/git_dyhit/HiT'
    settings.result_plot_path = '/home/kb/kb/git_dyhit/HiT/test/result_plots'
    settings.results_path = '/media/kb/2T5/hit_git/raw_results'    # Where to store tracking results
    settings.save_dir = '/home/kb/kb/git_dyhit/HiT'
    ...
    settings.tnl2k_path = '/media/kb/08AC1CC7272DCD64/trackingdata/test/TNL2K_test_subset'
    settings.tpl_path = ''
